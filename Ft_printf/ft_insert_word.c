...
/*   Updated: 2017/12/19 13:35:00 by yoginet     ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
char	*ft_insert_int(char *new, s_struct *data, int index, char word)
{
	int		i;
	int		j;
	int		x;
	...
	ft_strdel(&string);
	ft_putstr("----------------------------	start ft_inser_int\n");
	ft_putstr(new);
	ft_putstr("----------------------------	  end ft_inser_int\n");
	return (new);
